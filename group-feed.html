					...
					<div class="col-lg-12">
						<div class="row merged20" id="page-contents">
							<div class="user-profile">
								<figure>
									<a href="#" title="" class="join-btn" data-ripple=""><i class="fa fa-thumbs-o-up"></i> Join Group</a>
									<div class="edit-pp">
									...
									<img src="images/resources/profile-image3.jpg" alt="">
									...
									<div class="row">
										<div class="col-lg-2 col-md-3">
											<div class="profile-author">
												<div class="profile-author-thumb">
													<img alt="author" src="images/resources/group11.jpg">
													<div class="edit-dp">
														<label class="fileContainer">
															<i class="fa fa-camera"></i>
															<input type="file">
												...
												<div class="author-content">
													<a class="h4 author-name" href="about.html">School Mates</a>
													<div class="country">@schoolmate official</div>
												</div>
											</div>
										</div>
										<div class="col-lg-10 col-md-9">
											<ul class="profile-menu">
												<li>
													<a class="active" href="timeline.html">Groupfeed</a>
												</li>
												<li>
													<a class="" href="about.html">About</a>
												</li>
												<li>
													<a class="" href="timeline-friends.html">Members</a>
												</li>
												<li>
												...
												<li>
													<div class="more">
														...
														<ul class="more-dropdown">
															<li>
																<a href="timeline-groups.html">Events</a>
															</li>
															<li>
							...
							<div class="col-lg-3">
								<aside class="sidebar static left">
									<div class="widget">
										<h4 class="widget-title">Group Info</h4>
										<ul class="grouppage-info">
											<li><i class="fa fa-user-o"></i><span>Admin</span> @School Team</li>
											<li><i class="fa fa-users"></i><span>Members:</span>12132</li>
											<li><i class="fa fa-map-marker"></i><span>Location: </span> USA</li>
											<li><i class="fa fa-thumbs-o-up"></i><span>Daily Posts</span> 120</li>
											<li><i class="fa fa-filter"></i><span>category</span> Students</li>
										</ul>
									</div>
							...
							<div class="col-lg-6">
								...
								<div class="central-meta">
									<span class="create-post">Invite Members <a href="#" title="">See All</a></span>
							...
							<div class="col-lg-3">
								<aside class="sidebar static right">
									<div class="widget">
										<h4 class="widget-title">Social Share</h4>
										<ul class="socials">
											<li class="facebook">
									...
									<div class="widget">
										<h4 class="widget-title">Recent Photos <a title="" href="#" class="see-all">see all</a></h4>
										<ul class="recent-photos">
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-11.jpg" class="strip">
													<img alt="" src="images/resources/recent-1.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-22.jpg" class="strip">
													<img alt="" src="images/resources/recent-2.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-33.jpg" class="strip">
													<img alt="" src="images/resources/recent-3.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-44.jpg" class="strip">
												<img alt="" src="images/resources/recent-4.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-55.jpg" class="strip">
													<img alt="" src="images/resources/recent-5.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-66.jpg" class="strip">
													<img alt="" src="images/resources/recent-6.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-77.jpg" class="strip">
													<img alt="" src="images/resources/recent-7.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-88.jpg" class="strip">
													<img alt="" src="images/resources/recent-8.jpg"></a>
											</li>
											<li>
												<a data-strip-group-options="loop: false" data-strip-group="mygroup" title="" href="images/resources/recent-99.jpg" class="strip">
													<img alt="" src="images/resources/recent-9.jpg"></a>
											</li>
										</ul>
									</div><!-- recent photos -->
									<div class="widget">
